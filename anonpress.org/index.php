	...
	<section>
		...
		<ul class="links">
			...
			<li><h4 class="weak"><a href="/faq">AA Questions &amp; FAQ</a></h4>
				<ul>
					<li><span class="def">Frequently</span> <span class="def">Asked</span> <span
							class="def">Questions</span> about AA
				</ul>
			...
			<li><h4 class="weak"><a href="/spencer">The Spencer Misquotation</a></h4>
				<ul>
					<li class="small">The research proving Herbert Spencer<br>did not write the quote about avoiding<br>"contempt
	...
	<section>
		...
		<ul class="links">
			...
			<li><h4 class="weak"><a href="/sobrietycheck">SobrietyCheck</a></h4>
				<ul>
					<li class="small">Sobriety counter for Windows
				</ul>
		...
		<div style="max-width: 350px;">
			...
			<ul class="links polls">
				<li><h4 class="weak"><a class="colon" href="/polls/results.htm">Previous polls</a></h4>
					<ul>
						<li><a href="polls/results.htm#24" title="Very Optimistic…">Do you think you will drink
								again?</a>
						<li><a href="polls/results.htm#19" title="Probably…">Do you think believe newcomers should avoid
								dating?</a>
						<li><a href="polls/results.htm#17" title="We disagree…">Do you think drug addiction and
								alcoholism are the same thing?</a>
						<li><a href="polls/results.htm#23" title="Yeah, probably…">Is the next drink a choice if you
								have been sober a while? </a>
						<li><a href="polls/results.htm#1" title="Most people think it is OK…">Is it appropriate to use
								the Lord's Prayer in meetings?</a>
					</ul>
				...
				<li class="center"><a
						title="Sometimes we get curious about how the fellowship beyond our homegroup feels about stuff. Since we get AA folks visiting from all over we thought we might try getting a sense for how people feel about a few different things. The results are not scientific but we do think they give a rough idea of the sentiment of the fellowship.">About
						this poll</a>
			</ul>
		</div>
	</section>
		...
		<div class="optional flex" style="justify-content: space-between; align-items: center;">
			<ul class="links" style="max-width: 35em; margin-right: 2em;">
				<li><h4 class="weak" style="margin: 0;"><a href="/info/local_meetings.htm">Meeting information</a></h4>
					<ul>
						<li class="small">How to find an AA meeting.</li>
					</ul>
				<li><h4 class="weak"><a href="/faq">AA FAQ</a></h4>
					<ul>
						<li class="small">Answers to most of the questions<br>we are asked about AA.
					</ul>
				<li><h4 class="weak"><a href="/info/statemen.htm">About us</a></h4>
					<ul>
						<li class="small">Includes a FAQ about us.
					</ul>
			...
			<div style="text-align: center; margin: 1em;">
				...
				<p style="margin-bottom: 0;"><strong style="color: #900;">Please</strong><span class="small"> do <em
							style="color: red;">not</em> write with<br>questions about meetings</span><br>
...
<section>
	...
	<ol style="margin: 0 0 5em 0;" class="small">
		...
		<li>Sought through prayer and meditation to improve our conscious contact with God as we understood Him, praying
			only for knowledge of His will for us and the power to carry that out.
		<li>Having had a spiritual awakening as the result of these steps, we tried to carry this message to alcoholics,
